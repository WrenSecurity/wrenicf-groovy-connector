...
def builder = builder as SchemaBuilder

ObjectClassInfoBuilder user = new ObjectClassInfoBuilder()
user.addAttributeInfo(PredefinedAttributeInfos.DESCRIPTION)
user.addAttributeInfo(PredefinedAttributeInfos.GROUPS)
user.addAttributeInfo(OperationalAttributeInfos.CURRENT_PASSWORD)
user.addAttributeInfo(OperationalAttributeInfos.ENABLE)
builder.defineObjectClass(user.build())